              ...
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  >
                    {/* The Culture Wire */}
                    <img
                      src={!darkMode ? require(`../static/img/53logo.png`) : require(`../static/img/53logo.png`)}
                      alt=""
                    />
                  </Link>
                </Col>
            ...
            <Layout>
              {!topMenu || window.innerWidth <= 991 ? (
                <ThemeProvider theme={darkTheme}>
                  <Sider width={230} style={SideBarStyle} collapsed={collapsed} theme={!darkMode ? 'light' : 'dark'}>
                    <Scrollbars
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2022 © The-Culture-Wire</span>
                      </Col>
                      <Col md={12} xs={24}>
                      </Col>
                    </Row>
